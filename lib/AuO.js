...
disabled. Please instantiate AuO with an upload URL if you wish to enable online recording.");
    ...
    for (node of [audioTicker, audioStartTrimmer, audioStartTrimmerVisual, audioEndTrimmer,
            audioEndTrimmerVisual, audioVisualizer, container]) {
