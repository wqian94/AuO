...
const AuO = function (SAVE_URL = null) {
    ...
    const beginAudioDisplayLoop = function () {
        ...
        state.callbackDraw = setInterval(function () {
            ...
            window.requestAnimationFrame(animateCurrentTimeTicker);
     ...
     */
    const animateCurrentTimeTicker = function () {
    ...
    buttonPlay.listen("click", function (event) {
        ...
        const currentTime = state.audioPlaybackCurrentTime();
        const totalTime = state.elapsedTime;
        const startTime = (timeEqualsA(currentTime, totalTime) ? 0 : currentTime);
