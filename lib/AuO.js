...
(function () {
     ...
     * Create new rules by calling Sheet.rule(DOM string of rule). Rules will be automatically
     * prepended with ".namespace " with the noticeable space.
     */
    const Sheet = new (function() {
        ...
        this.rule = function (rule) {
            sheet.insertRule("." + namespace + " " + rule, sheet.cssRules.length);
        };
    })();

    ////////////////////////////////////////////////////////////////////////////////////////////////
    //
    // Styling the main container to induce horizontal and vertical centering.
    //
    ////////////////////////////////////////////////////////////////////////////////////////////////
