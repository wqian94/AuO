...
const AuO = function () {
     ...
     *     style -- wrapper for style.setProperty(property, value).
     *     append -- wrapper for appendChild(child).
     *     remove -- wrapper for removeChild(child).
     *     attach -- appends the element to the specified parent.
     *     detach -- removes the element as a child of its parent.
     *     listen -- wrapper for addEventListener(event, callback).
     *
     * @constructor
     */
